            ...
            [
                self.Arg(
                    ...
                    import_if=(
                        ...
                        and "Atom" in cpu.brand
                        and self.version >= 11.0
                    ),
                ...
                self.Arg(
                    args="/favor:INTEL64",
                    suffix="intel",
                    import_if=(cpu.vendor == "GenuineIntel" and arch == "x86_64"),
                    build_if=arch == "x86_64",
                ),
                self.Arg(
                    args="/favor:AMD64",
                    suffix="amd",
                    import_if=(cpu.vendor == "AuthenticAMD" and arch == "x86_64"),
                    build_if=arch == "x86_64",
                ),
                self.Arg(),
            ],
