...
def tests_import_class():
    ...
    assert import_class("compilers", "_core", "CompilerBase", Dummy) is CompilerBase

    # Module not exist: return default
    assert import_class("not_exists", "_core", "CompilerBase", Dummy) is Dummy

    # Class not exists: return default
    assert import_class("compilers", "_core", "Not_Exists", Dummy) is Dummy
